...
public class GradeApp extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    goodGradePanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Good Grade - " + Graph.getGraph().getGoodgrade()));

    gradeSlider.setPaintLabels(true);
    gradeSlider.setValue((int)(Graph.getGraph().getGoodgrade()));
    ...
    noiseSliderPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Noise - " + Graph.getGraph().getNoise()));
